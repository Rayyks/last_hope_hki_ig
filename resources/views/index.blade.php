                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-box pink">
                            ...
                            <h3>Manual Book</h3>
                            <p>
                                Silahkan lihat manual book untuk mengetahui tata cara melakukan pengajuan hak cipta di Sentra HKI.
                            </p>
                            <a href="/manual" class="read-more"><span>Lihat</span> <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
