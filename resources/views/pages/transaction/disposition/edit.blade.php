...
@section('content')
<x-breadcrumb :values="[__('Pengajuan Masuk'), $letter->email, __('Status Pengajuan'), __('Edit Status')]">
</x-breadcrumb>
            ...
            <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                <div class="mb-3">
                    ...
                    <select class="form-select" id="letter_status" name="letter_status">
                        ...
                        <option value="{{ $status->id }}" @selected(old('letter_status', $data->letter_status) == $status->id)>
                            {{ $status->status }}
                        </option>
                        @endforeach
                    </select>
