            ...
            <form action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="{{ $data->profile_picture }}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <dt class="col-sm-3 mt-3 m-auto text-center mb-3">{{ __('Ubah Password') }}</dt>
                        <hr class="my-0">
