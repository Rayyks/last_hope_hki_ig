<div class="card">
    <div class="card-body">
        <div class="card-title d-flex align-items-start justify-content-between">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                    ...
                    <a class="dropdown-item" href="{{ route('transaction.incoming.index') }}">{{ __('dashboard.view_more') }}</a>
                    @elseif($label == __('dashboard.active_user'))
                    <a class="dropdown-item" href="{{ route('user.index') }}">{{ __('dashboard.view_more') }}</a>
                    @endif
                </div>
            </div>
            @endif
        ...
        @elseif($percentage < 0) <small class="text-danger fw-semibold"><i class="bx bx-down-arrow-alt"></i> {{ $percentage }}%</small>
            @endif
    </div>
</div>